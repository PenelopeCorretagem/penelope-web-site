...
import { useAdvertisementsCarouselViewModel } from '@shared/components/features/AdvertisementsCarousel/useAdvertisementsCarouselViewModel'
...
export const AdvertisementsCarouselView = memo(function AdvertisementsCarouselView({
  ...
  const {
    ...
    callToActionButton
  } = useAdvertisementsCarouselViewModel(advertisements, advertisementCardMode, titleCarousel)
  ...
  const getRouteOrFallback = (routeName, params) => {
    try {
      ...
      // Falha ao gerar rota, usar fallback
  ...
  const handleActionClick = () => {
    ...
    try {
      ...
      // Fallback silencioso para erros de navegação
    }
