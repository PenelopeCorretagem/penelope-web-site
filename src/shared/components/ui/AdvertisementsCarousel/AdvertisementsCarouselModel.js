...
export class AdvertisementsCarouselModel {
  ...
  get advertisementCardMode() {
    return this.#advertisementCardMode
  }

  set advertisementCardMode(value) {
    if (!value) {
      this.#advertisementCardMode = ADVERTISEMENT_CARD_MODES.DEFAULT
      return
    }

    if (Object.values(ADVERTISEMENT_CARD_MODES).includes(value)) {
      this.#advertisementCardMode = value
      return
    }

    this.#advertisementCardMode =
      ADVERTISEMENT_CARD_MODES[value] || ADVERTISEMENT_CARD_MODES.DEFAULT
  }
