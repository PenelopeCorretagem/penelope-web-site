/**
 * TextView component renders styled text content.
 ...
 * @param {string} [props.className=''] - Optional CSS class names to extend or override base styles.
...
export function TextView({ children, className = '', as = 'p' }) {
  ...
  const baseClasses = 'text-base md:text-lg leading-none font-default text-default-dark'
