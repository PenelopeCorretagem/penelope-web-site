export class NavItemModel {
  ...
  isValidVariant() {
    return NavItemModel.VARIANTS.includes(this.variant)
  }
  ...
  updateVariant(newVariant) {
    if (!NavItemModel.VARIANTS.includes(newVariant)) {
      throw new Error(
        `Invalid variant. Must be one of: ${NavItemModel.VARIANTS.join(', ')}`
      )
    }
