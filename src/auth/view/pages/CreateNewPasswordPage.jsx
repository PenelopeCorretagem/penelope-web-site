    ...
    <div className="flex h-screen w-full overflow-hidden">
      ...
      <div className="flex w-1/2 flex-col items-center justify-center bg-gradient-to-br from-[#B33C8E] to-[#36221D] p-10 text-white">
        <div className="w-full max-w-lg text-center">
          ...
          <p className="mt-6 text-lg leading-relaxed">
            VAMOS TE AJUDAR, INFORME SUA NOVA SENHA E CLIQUE NO BOTÃO “REDEFINIR SENHA”.
          </p>
        </div>
      </div>
      ...
      <div className="relative flex w-1/2 flex-col items-center justify-center bg-white p-10">
        ...
        <div className="w-full max-w-md text-center">
          <h2 className="text-4xl font-bold text-[#B33C8E] mb-8">REDEFINIR SENHA</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="relative">
              ...
              />
              <button type="button" className="absolute inset-y-0 right-0 flex items-center px-4 text-gray-600" onClick={() => setShowNewPassword(!showNewPassword)}>
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-4 py-3 pr-12 rounded-md bg-[#E9BEDC] placeholder:text-black text-black focus:outline-none focus:ring-2 focus:ring-[#B33C8E]"
              />
              <button type="button" className="absolute inset-y-0 right-0 flex items-center px-4 text-gray-600" onClick={() => setShowConfirmPassword(!showConfirmPassword)}>
