...
export function useAppointmentFormViewModel(
  ...
  useEffect(() => {
    ...
    const loadClients = async () => {
      ...
      try {
        ...
        setClientsError(error.message || 'Erro ao carregar clientes disponíveis')
      } finally {
  ...
  useEffect(() => {
    const loadData = async () => {
      ...
      try {
        ...
        setEstatesError(error.message || 'Erro ao carregar imóveis disponíveis')
      } finally {
  ...
  useEffect(() => {
    const loadAvailableSlots = async () => {
      ...
      try {
        ...
        setAvailableSlots([])
        setSlotsError(error.message || 'Erro ao carregar horários disponíveis')
      } finally {
  ...
  const handleSubmit = useCallback(async () => {
    ...
    try {
      ...
      setSubmitError(error.message || (isRescheduleMode ? 'Erro ao reagendar agendamento' : 'Erro ao criar agendamento'))
      return false
    } finally {
