 ...
 */
export class AdvertisementConfigModel {
  constructor(advertisement = null) {
    ...
    // Extract differentials from amenities (keep as Feature objects)

    this.differentials = Array.isArray(estate?.amenities) ? [...estate.amenities] : []
  ...
  /**
   * Cria um AdvertisementConfigModel a partir de uma entidade Advertisement
   */
  static fromAdvertisementEntity(advertisementEntity) {
    ...
    return new AdvertisementConfigModel(advertisementEntity)
  }
  ...
  toFormData() {
    ...
    const formData = {
      ...
      advertisementDescription: this.advertisementDescription,
  ...
  toApiRequest(formData, uploadedImageData = [], availableAmenities = []) {
    ...
    const request = {
      ...
      estate: {
        ...
        title: sanitizeString(formData.advertisementTitle, 255),
        description: sanitizeString(formData.advertisementDescription, 1000),
        area: formatAreaForDatabase(formData.area) || 0,
        numberOfRooms: sanitizeNumber(formData.numberOfRooms),
        type: sanitizeAdvertisementType(formData.advertisementType),
        address: {
