...
export function UsersList({ users, onEdit, onDelete, loading = false }) {
  return (
    <div className="flex flex-col gap-card md:gap-card-md overflow-y-auto flex-1 bg-default-light-alt rounded-sm scrollbar-thin scrollbar-thumb-distac-secondary scrollbar-track-default-light-muted hover:scrollbar-thumb-distac-primary">
