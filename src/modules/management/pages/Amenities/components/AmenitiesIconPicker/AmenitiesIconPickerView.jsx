...
import { useAmenitiesIconPickerViewModel } from './useAmenitiesIconPickerViewModel'

/**
 * AmenitiesIconPicker - Modal para seleção de ícones do lucide-react
 *
 * RESPONSABILIDADES:
 ...
 */
export function AmenitiesIconPicker({ isOpen, onClose, onSelectIcon, currentIcon }) {
  const {
    filters,
    filteredIcons,
    availableInitials,
    handleFiltersChange,
    handleResetFilters,
  } = useAmenitiesIconPickerViewModel(isOpen)
