...
export class ReportModel {
  ...
  constructor(appointments = [], periodType = PERIOD_TYPES.MONTHLY) {
  ...
  getConfirmationRate() {
    ...
    return Math.round((confirmed / this.#appointments.length) * 100)
  }
  ...
  getCompletionRate() {
    ...
    const concluded = this.#appointments.filter(a => a.status === 'CONCLUDED').length
  ...
  getCancellationRate() {
    ...
    return Math.round((cancelled / this.#appointments.length) * 100)
  }
