...
import { AdvertisementTabsModel } from './AdvertisementTabsModel'

export function useAdvertisementTabsViewModel(anchors, tabs) {
  const [model] = useState(() => new AdvertisementTabsModel({ tabs, anchors }))
